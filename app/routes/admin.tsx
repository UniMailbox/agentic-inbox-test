...
export default function AdminRoute() {
	...
	return (
		<div className="mx-auto max-w-4xl px-4 py-8 md:px-6 md:py-12">
			<div className="mb-6">
				<h1 className="text-2xl font-bold text-kumo-default">Users</h1>
				<p className="text-sm text-kumo-subtle mt-1">
					Everyone who has signed in. Promote admins and deactivate users
					you no longer want in the app.
				</p>
			</div>
						...
						<tbody>
							{users.map((u) => {
								...
								return (
									<tr
										key={u.id}
										className="border-t border-kumo-line align-middle"
									>
